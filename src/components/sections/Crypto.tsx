...
const Crypto: React.FC = () => {
	/* ===== Constants ===== */
	const cryptocurrencies = ['Bitcoin (BTC)', 'Ethereum (ETH)', 'Solana (SOL)', 'Chainlink (LINK)', 'Avalanche (AVAX)'];
	...
	return (
		<BaseView id='crypto' title='Cryptocurrency Insights'>
			...
			<ContentCard>
				...
				<ListWithTitle className='mt-6' items={cryptocurrencies} title='Popular Cryptocurrencies' />
