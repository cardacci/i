	...
	return (
		<section id="resume" className="py-10 max-w-5xl mx-auto">
			...
			<div className="resume-content mt-8 bg-white p-6 rounded-lg shadow-md">
				...
				<h3 className="text-xl font-semibold mt-6 mb-4 text-gray-800">Education</h3>
				<ul className="list-disc pl-5 space-y-2">
					<li>[Degree] in [Field of Study], [University], [Year]</li>
					<li>[Additional Degrees or Certifications]</li>
				</ul>

				<h3 className="text-xl font-semibold mt-6 mb-4 text-gray-800">Experience</h3>
				<ul className="list-disc pl-5 space-y-2">
					<li>[Job Title] at [Company] - [Year] to [Year]</li>
					<li>[Job Title] at [Company] - [Year] to [Year]</li>
				</ul>

				<h3 className="text-xl font-semibold mt-6 mb-4 text-gray-800">Skills</h3>
				<ul className="list-disc pl-5 space-y-2">
					<li>[Skill 1]</li>
					<li>[Skill 2]</li>
					<li>[Skill 3]</li>
